...
exports.GeneratedMigration1763380250595 = void 0;
class GeneratedMigration1763380250595 {
    constructor() {
        this.name = 'GeneratedMigration1763380250595';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "course" ("id" SERIAL NOT NULL, "title" character varying(255) NOT NULL, "description" text, "start_date" date NOT NULL, "end_date" date NOT NULL, "status" character varying(255) NOT NULL, CONSTRAINT "PK_bf95180dd756fd204fb01ce4916" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "student" ("id" SERIAL NOT NULL, "first_name" character varying(255) NOT NULL, "last_name" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "enrollment_date" date NOT NULL, "status" character varying(255) NOT NULL, CONSTRAINT "PK_3d8016e1cb58429474a3c041904" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "instructor" ("id" SERIAL NOT NULL, "first_name" character varying(255) NOT NULL, "last_name" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "hire_date" date NOT NULL, "status" character varying(255) NOT NULL, CONSTRAINT "PK_ccc0348eefb581ca002c05ef2f3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "assignment" ("id" SERIAL NOT NULL, "title" character varying(255) NOT NULL, "description" text, "due_date" date NOT NULL, "status" character varying(255) NOT NULL, CONSTRAINT "PK_43c2f5a3859f54cedafb270f37e" PRIMARY KEY ("id"))`);
...
exports.GeneratedMigration1763380250595 = GeneratedMigration1763380250595;
//# sourceMappingURL=1763380250595-generated-migration.js.map